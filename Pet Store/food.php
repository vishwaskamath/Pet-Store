...
<body>
    ...
    <div class="row" style="background-color: black;">
        ...
        <br>
        <div style="text-align: center">
        <a href="product.php"> <button class="button">Accessories</button></a>
        

        <a href="food.php"> <button class="button">Food</button></a>
        </div>
        ...
        ?>
            <div class="col-sm-4" style="text-align: center;">
                <div class="card2">
                  ...
                  <a href="des.php">  <button type="button" >More</button></a>
                ...
                <br>
                <div style="text-align: center">
                    <a href="cart.php"> <button style="    padding: 10px;
                                color: white;
                                background: blue;
                                border-radius: 50%;"><b>
                                ADD to Cart
