...
<body>
    ...
    <div id="header" style="text-align: center">
        <label style="color: white">Insert ngo</label>
    </div>
    <br>
    ...
    <div style="padding: 50px; background-color: azure; width: 30%;height:  260px; text-align: center; border-radius: 5%; box-shadow: cornsilk; margin-left: 31%;">
            ...
            <form action="upload_ngo.php" method="post" enctype="multipart/form-data">
    ...
    border-radius: 10%;"><b>
        ...
        ?>
           <div style="text-align: center">
                <label>File Uploaded Successfully... <a href="ngo.php">click here to view file.</a></label>
            </div>
        <?php
