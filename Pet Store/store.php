<!--    1. DISPLAYING PETS THAT ARE AVAILABLE IN THE SHOP:
We display pets which are available in the shop. Users can aware of pets which are available.-->
<html lang="en">
...
<body>
    ...
    <div class="row" style="background-color: black;">
        <br>
        <h1 style="color: crimson ; text-align: center;"><b>AVAILABLE PETS</b> </h1>
        <h3 style="color: crimson ; text-align: center;">Explore all pets & breeds! </h3>
        <br>
        <div style="text-align: center;">
        ...
        ?>
            <div class="col-sm-4" style="text-align: center; background-color:black;color:cornsilk">
                <div class="card2">
                    <br>
