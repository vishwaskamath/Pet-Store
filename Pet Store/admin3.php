...
foreach ($_SESSION["cart_item"] as $item) {
    ...
    mysqli_query($db1,"INSERT INTO orders(code,name,price,quantity,cname,address,phone) VALUES ('$code','$name','$price','$quantity','$cname','$address','$phone')");
...
<body>
    ...
    <div style="background:url(images/banner_3.jpg);">
        ...
        <div style="text-align: center;">
            <img src="images/logo.jpeg" alt="logo" width="250px" height="250px"
                style="border-radius: 50%; box-shadow: 0 10px 16px 0 rgba(0,0,0,0.2),0 6px 20px 0 rgba(0,0,0,0.19) !important;">
        </div>
        <br>
        <br>
    ...
    <div style="text-align: center">
        <p>Congratulations!</p>
<p>You have successfully completed the purchase!.</p>
    </div>
