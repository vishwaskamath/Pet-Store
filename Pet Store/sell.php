...
<body>
    ...
    <div style="background:url(images/banner_3.jpg);">
        ...
        <p style="text-align: center;font-size:25px; padding:10%">
            Hey there want to sell your pet? We have all your needs covered, post and advertisement in our website to sell your pet ! 
    
        <a href="insert_sell.php"> <button type="button"  class="btn btn-info btn-lg view">POST</button></a>
