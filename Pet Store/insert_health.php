...
<body>
    ...
    <div id="header" style="text-align: center">
        <label style="color: white">Insert health</label>
    </div>
    <br>
    ...
    <div id="body">
        <div style="padding: 50px; background-color: azure; width: 30%;height:  260px; text-align: center; border-radius: 5%; box-shadow: cornsilk; margin-left: 31%;">
            ...
            <form action="upload_health.php" method="post" enctype="multipart/form-data">
            ...
            ?>
                <div style="text-align: center">
                    <label>File Uploaded Successfully... <a href="health.php">click here to view file.</a></label>
                </div> <?php
