...
<body>
    ...
    <div style="text-align: center">
        <form action="dailyreport.php" method="POST">
            ...
            <input type="text" placeholder="Format : YYYY-MM-DD" style="color:#000" name="data" required />
    ...
    <div style="text-align: center;">
        <p>Click to Update product delivery status</p>
        <form action="display.php" method="POST">
            Enter the Customer Name:
            <br>
            <br>
            <input type="text" placeholder="Customer Name" style="color:#000" name="cname" required />
            <br>
            <br>
            <button type="submit" style="background: black">Submit</button>
        </form>
