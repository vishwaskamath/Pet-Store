...
<body>
    ...
    <div style="background:url(images/banner_3.jpg);">
        ...
        <br>
        <br>
        <p style="text-align: center;font-size:25px; padding:10%">
            Hey there, have you lost your pet? We have all your needs covered, post and advertisement in our website to find your lost pet ! 
    
        <a href="insert_lost.php"> <button type="button"  class="btn btn-info btn-lg view">POST</button></a>
    ...
    <div class="row" style="background-color: black;">
        ...
        $sql = "SELECT * FROM lost  where status='1'";
